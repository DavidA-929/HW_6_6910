...
```{r}
Y_i_var <- tapply(boiling.data$z, boiling.data$salt, var); Y_i_var
Y_j_var <- tapply(boiling.data$z, boiling.data$burner, var); Y_j_var
Y_ij_var <- tapply(boiling.data$z, boiling.data$trtmt, var); Y_ij_var
