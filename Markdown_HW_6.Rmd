...
From the plot of Order vs. Std. Residuals we can see that there isn't an apparant pattern as time increases. Therefore we feel comfortable to say that the assumption that errors are independent is approximately satisfies.
