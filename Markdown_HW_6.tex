...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Y_i_var <-}\StringTok{ }\KeywordTok{tapply}\NormalTok{(boiling.data}\OperatorTok{$}\NormalTok{time, boiling.data}\OperatorTok{$}\NormalTok{salt, var); Y_i_var}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##        0        2        4        6 
## 3.696970 2.545455 3.295455 2.265152
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Y_j_var <-}\StringTok{ }\KeywordTok{tapply}\NormalTok{(boiling.data}\OperatorTok{$}\NormalTok{time, boiling.data}\OperatorTok{$}\NormalTok{burner, var); Y_j_var}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##         1         2         3         4 
## 1.1515152 0.1515152 0.4469697 0.6287879
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Y_ij_var <-}\StringTok{ }\KeywordTok{tapply}\NormalTok{(boiling.data}\OperatorTok{$}\NormalTok{time, boiling.data}\OperatorTok{$}\NormalTok{trtmt, var); Y_ij_var}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##        10        12        14        16        20        22        24 
## 0.3333333 3.0000000 0.0000000 1.3333333 0.0000000 0.3333333 0.3333333 
##        26        30        32        34        36        40        42 
## 0.0000000 0.3333333 0.3333333 0.3333333 0.3333333 0.0000000 0.0000000 
##        44        46 
## 1.0000000 0.3333333
\end{verbatim}
...
around zero. However there seems to be one aparrent outlier. Hence, with
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{max}\NormalTok{(}\KeywordTok{abs}\NormalTok{(boiling.data}\OperatorTok{$}\NormalTok{z))}
\end{Highlighting}
\end{Shaded}
...
apparant pattern as time increases. Therefore we feel comfortable to say
...
##  0 - 2     0.66666667 0.2803405 41   2.378  0.0974
##  0 - 4    -0.08333333 0.2803405 41  -0.297  0.9907
##  0 - 6     0.75000000 0.2803405 41   2.675  0.0503
##  2 - 4    -0.75000000 0.2803405 41  -2.675  0.0503
##  2 - 6     0.08333333 0.2803405 41   0.297  0.9907
##  4 - 6     0.83333333 0.2803405 41   2.973  0.0244
## 
...
\begin{verbatim}
##  contrast   estimate        SE df t.ratio p.value
##  1 - 2     2.5000000 0.2803405 41   8.918  <.0001
##  1 - 3     0.5833333 0.2803405 41   2.081  0.1764
##  1 - 4    -1.7500000 0.2803405 41  -6.242  <.0001
##  2 - 3    -1.9166667 0.2803405 41  -6.837  <.0001
##  2 - 4    -4.2500000 0.2803405 41 -15.160  <.0001
##  3 - 4    -2.3333333 0.2803405 41  -8.323  <.0001
## 
