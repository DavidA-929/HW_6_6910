...
Design II is connected and we have that $v=9$, $b=9$, $k=3$, and $r=3$. However it is not a balanced imcomplete block design by the calculations below.
...
Since we are still assuming $k=5$, then we must have that $vr = bk$, so $5(15) = b (5)$. Then $b=5$. So this design must have 5 blocks.
